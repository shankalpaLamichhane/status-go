...
func (c cacheFixture) BalanceAt(client BalanceReader, ctx context.Context, account common.Address, blockNumber *big.Int) (*big.Int, error) {
	return c.BalanceAt(client, ctx, account, blockNumber)
}
