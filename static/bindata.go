...
func ConfigReadmeMd() (*asset, error) {
	...
	info := bindataFileInfo{name: "../config/README.md", size: 3132, mode: os.FileMode(0644), modTime: time.Unix(1578644702, 0)}
...
func ConfigCliFleetEthBetaJson() (*asset, error) {
	...
	info := bindataFileInfo{name: "../config/cli/fleet-eth.beta.json", size: 3228, mode: os.FileMode(0644), modTime: time.Unix(1578644702, 0)}
...
func ConfigCliFleetEthProdJson() (*asset, error) {
	...
	info := bindataFileInfo{name: "../config/cli/fleet-eth.prod.json", size: 3234, mode: os.FileMode(0644), modTime: time.Unix(1578644702, 0)}
...
func ConfigCliFleetEthStagingJson() (*asset, error) {
	...
	info := bindataFileInfo{name: "../config/cli/fleet-eth.staging.json", size: 1848, mode: os.FileMode(0644), modTime: time.Unix(1578644702, 0)}
...
func ConfigCliFleetEthTestJson() (*asset, error) {
	...
	info := bindataFileInfo{name: "../config/cli/fleet-eth.test.json", size: 1527, mode: os.FileMode(0644), modTime: time.Unix(1578644702, 0)}
